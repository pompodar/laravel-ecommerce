...
INSERT INTO `attribute_product` VALUES (14,41,1,NULL,NULL),(15,43,1,NULL,NULL);
...
INSERT INTO `carts` VALUES (15,1,41,5,'2023-12-02 16:31:44','2023-12-02 16:38:46',NULL);
...
INSERT INTO `category_product` VALUES (20,2,41,NULL,NULL);
...
INSERT INTO `order_items` VALUES (1,4,22,7,'2023-11-19 17:04:36','2023-11-19 17:04:36'),(2,7,31,3,'2023-11-25 10:16:03','2023-11-25 10:16:03'),(3,7,30,7,'2023-11-25 10:16:03','2023-11-25 10:16:03'),(4,8,37,2,'2023-11-27 17:43:30','2023-11-27 17:43:30'),(5,9,37,2,'2023-11-27 18:12:00','2023-11-27 18:12:00'),(6,9,37,1,'2023-11-27 18:12:00','2023-11-27 18:12:00'),(7,10,41,14,'2023-11-30 11:12:37','2023-11-30 11:12:37'),(8,14,41,5,'2023-12-01 13:36:48','2023-12-01 13:36:48'),(9,14,43,1,'2023-12-01 13:36:49','2023-12-01 13:36:49');
...
INSERT INTO `orders` VALUES (1,1,'2023-11-19 16:56:24','2023-11-19 16:56:24'),(2,1,'2023-11-19 16:57:24','2023-11-19 16:57:24'),(3,1,'2023-11-19 16:58:19','2023-11-19 16:58:19'),(4,1,'2023-11-19 17:04:36','2023-11-19 17:04:36'),(5,1,'2023-11-25 10:10:03','2023-11-25 10:10:03'),(6,1,'2023-11-25 10:15:25','2023-11-25 10:15:25'),(7,1,'2023-11-25 10:16:03','2023-11-25 10:16:03'),(8,1,'2023-11-27 17:43:30','2023-11-27 17:43:30'),(9,1,'2023-11-27 18:12:00','2023-11-27 18:12:00'),(10,1,'2023-11-30 11:12:37','2023-11-30 11:12:37'),(11,1,'2023-11-30 11:14:24','2023-11-30 11:14:24'),(12,1,'2023-11-30 11:14:50','2023-11-30 11:14:50'),(13,1,'2023-11-30 11:16:35','2023-11-30 11:16:35'),(14,1,'2023-12-01 13:36:48','2023-12-01 13:36:48'),(15,1,'2023-12-01 13:37:52','2023-12-01 13:37:52'),(16,1,'2023-12-01 13:41:01','2023-12-01 13:41:01'),(17,1,'2023-12-01 13:41:44','2023-12-01 13:41:44'),(18,1,'2023-12-01 13:46:08','2023-12-01 13:46:08'),(19,1,'2023-12-01 13:46:53','2023-12-01 13:46:53'),(20,1,'2023-12-01 13:52:13','2023-12-01 13:52:13'),(21,1,'2023-12-01 13:53:18','2023-12-01 13:53:18'),(22,1,'2023-12-01 13:55:40','2023-12-01 13:55:40'),(23,1,'2023-12-01 13:56:01','2023-12-01 13:56:01'),(24,1,'2023-12-01 13:56:11','2023-12-01 13:56:11');
...
--
-- Table structure for table `product_variation_photos`
--

DROP TABLE IF EXISTS `product_variation_photos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_variation_photos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_variation_photos_product_variation_id_foreign` (`product_variation_id`),
  CONSTRAINT `product_variation_photos_product_variation_id_foreign` FOREIGN KEY (`product_variation_id`) REFERENCES `product_variations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `product_variation_photos`
--

/*!40000 ALTER TABLE `product_variation_photos` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_variation_photos` ENABLE KEYS */;
...
INSERT INTO `products` VALUES (41,'Bananas','bananas','Quick trips, long weekend getaways, and everything in between. Our bags are designed to do it all.',124.00,34,'product_photos/O60Pg8AinepzVGZaBIIbwUxh1NYnvjZDCgIumRKt.jpg','2023-11-28 17:41:34','2023-11-30 08:41:19'),(43,'Apples','apples','Quick trips, long weekend getaways, and everything in between. Our bags are designed to do it all.',100.00,45,'product_photos/72isLy0nuZAIw0yRfjCwytvqNmgJBr2D7ILgN5si.jpg','2023-12-01 08:24:46','2023-12-01 08:24:46');
...
-- Dump completed on 2023-12-02 20:00:17
